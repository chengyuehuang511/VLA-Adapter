...
class SPD(Optimizer):
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
        ...
        super(SPD, self).__init__(params, defaults)


    def __setstate__(self, state):
        super(SPD, self).__setstate__(state)
    ...
    def adam(self, 
        ...
        def update_parameter(param, grad, exp_avg, exp_avg_sq, step, pre_cpu=None):
            ...
            if pre_cpu is not None:
                if pre_cpu.device != param.device:
            ...
            if pre_cpu is not None and pre is not pre_cpu:
                del pre
        ...
        i = 0
        for pre_group, param in zip(group['pre'], group['params']):
            ...
            if self.use_lora:
                ...
                update_parameter(param, grad, exp_avg, exp_avg_sq, step, pre_group)
            i += 1
